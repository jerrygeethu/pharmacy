<td style="padding-top: 20px;" id="right-bg" align="LEFT" valign="top" width="1207">
	<form id="frmcat" name="frmcat" method="post" action="#" enctype="multipart/formdata">
		<table class="table" border="0" cellpadding="0" cellspacing="0" width="90%">
			<tbody>
				<tr><td class="titles">Add Articles</td></tr>
				<tr>
						...
						<table id="table-1" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								...
								<tr style="cursor: move;" class="td2" id="45">
									<td>Category</td>
									<td>  
										<select name="select" id="category" name="category" class="dropdown">
								...
								<tr style="cursor: move;" class="td2" id="45">
									<td>Article Titile</td>
									<td><input type="text" name="article_title" id="article_title" class="textarea" ></td>
								</tr>
								
								<tr style="cursor: move;" class="td2" id="44">
									<td>Descriptions<span class="red">*</span></td>
									<td>
										<textarea name="article_description" id="article_description" class="textfield-02"></textarea>
										<!--<input name="article_description" id="article_description" class="textfield-02" >-->
									</td>
								</tr>
								...
								<tr style="cursor: move;" class="td2" id="43">
									...
									<td>
										<input name="userfile1" id="userfile1" type="file"/>
									</td>
								</tr>
								
								<tr style="cursor: move;" class="td2" id="43">
									<td>Advertisement<span class="red">*</span></td>
									<td>
										<input name="userfile2"  id = "userfile2"type="file" />
									</td>
								</tr>
								...
								<tr style="cursor: move;" class="td2" id="44">
									...
									<td>
										...
										<!--<input name="description" id="description" class="textfield-02" >-->
									</td>
								</tr>
								...
								<tr style="cursor: move;"  class="td2" id="43">								
									<td colspan="2" style="padding-left:305px;"><label><input type="submit" name="button" class="button" value="Submit" /></label></td>
								</tr>
