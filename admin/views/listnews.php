...
<a href="<?php echo $base;?>admin.php/category/drugadd" > <strong>Add New Drug</strong>&nbsp;&nbsp;
...
<td class="headings" align="left" width="14%">Active</td>
...
<td><?php if($dr->is_active=="1") { echo "Yes" ; } else { echo "No"; }?></td>
<td align="right"><a href="<?php echo $base;?>admin.php/category/editdrug/<?php echo $dr->id; ?>/<?php echo $limit; ?>"><img src="<?php echo  $base;?>images/admin/edit.gif" alt="" border="0" height="14" width="14" /></a>&nbsp;</td>
