          ...
          <table class="table" border="0" cellpadding="0" cellspacing="0" width="90%">
            <tbody>
              <tr>
                <td class="titles">List Product Categories <span style="float:right;margin-right:20px;"><a href="<?php echo $base;?>admin.php/category/addcat" class="tdlink">Add New Category</a></span></td>
              </tr>
              <tr>
                ...
                <td valign="top"><table id="table-1" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                      <tr class="nodrag nodrop" style="background-color: rgb(184, 184, 185);">
                        ...
                        <td class="headings" align="left" width="25%"><a href="#"> Category</a></td>
                        <td class="headings" align="left" width="39%">Subcategory</td>
						<td class="headings" align="left" width="39%">Finestcategory</td>
                      ...
                      <tr style="cursor: move;" class="td2" id="45">
                        ...
                        <td><?php echo $ct->subcategory;?></td> 
						<td><?php echo $ct->finestcategory;?></td>
                       
                        <td align="right"><a href="<?php echo  $base;?>admin.php/category/editcat/<?php echo $ct->id;?>/<?php echo $limit;?>"><img src="<?php echo  $base;?>images/admin/edit.gif" alt="" border="0" height="14" width="14" /></a>&nbsp;</td>
                        <td align="right"><a href="<?php echo  $base;?>admin.php/category/deletecat/<?php echo $ct->id;?>/<?php echo $limit;?>" onclick="return confirm('Are you sure to delete category?');"><img src="<?php echo  $base;?>images/admin/trash.gif" border="0" /></a>&nbsp;</td>
                      </tr>
                     <?php $i++; } ?>          
