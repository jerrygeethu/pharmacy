...
<div id="consultation_outer">
	<div id="refill_outer">
		...
		<div id="createaccount_line"></div><?php echo $nav;?>
							...
							<div class="productcategories_mainouter" id='<?php echo $va[$i]->id;?>'>
								<div class="productcategories_outer">
									<div class="productcategories_head2">
										<a href="<?php echo $base;?>index.php/onlineshop/product/<?php echo $va[$i]->id;?>"><?php echo $va[$i]->category;?></a>
									</div>
									<div class="categories_img" >
										<div align="center">
											<a href="<?php echo $base;?>index.php/onlineshop/product/<?php echo $va[$i]->id;?>"><img style="border:1px solid #a7b5be;" src="<?php echo $base;?>images/category/<?php echo $va[$i]->image;?>" width="74" height="74" /></a>
										</div>
									</div>
									<?php
										$id=$va[$i]->id;
									...
									?>
											<div class="productcategories">
												...
												<a href="" id="p<?php echo $sh;?>-show" class="showLink" onclick="showHide('p<?php echo $sh;?>');return false;">Show more...</a></p>
												<div id="p<?php echo $sh;?>" class="show_hide">
													...
													<p><a href="" id="p<?php echo $sh;?>-hide" class="hideLink" onclick="showHide('p<?php echo $sh;?>');return false;">Hide</a></p>
												</div>
											</div>		
									<?php
										}
								...
								<div class="productcategories_outer">
									...
									?>
											<div class="productcategories">
												...
												<a href="" id="q<?php echo $sh;?>-show" class="showLink" onclick="showHide('q<?php echo $sh;?>');return false;">Show more...</a></p>
												<div id="q<?php echo $sh;?>" class="show_hide">
													<div class="productcategories">
														...
														<p><a href="" id="q<?php echo $sh;?>-hide" class="hideLink" onclick="showHide('q<?php echo $sh;?>');return false;">Hide</a></p>												
													</div>
												</div>
											</div>
									<?php
								...
								<div class="productcategories_outer">
									<div class="productcategories_head2"><a href="<?php echo $base;?>index.php/onlineshop/product/<?php echo $va[$i+2]->id;?>"><?php echo $va[$i+2]->category;?></a></div>
									<div class="categories_img" >
										<div align="center"><a href="<?php echo $base;?>index.php/onlineshop/product/<?php echo $va[$i+2]->id;?>"><img style="border:1px solid #a7b5be;" src="<?php echo $base;?>images/category/<?php echo $va[$i+2]->image;?>" width="74" height="74" /></a></div>
									</div>
									<?php
										$id=$va[$i+2]->id;
										$cnt=count($cats[$id]);
									...
									?>
											<div class="productcategories">
												...
												<a href="" id="r<?php echo $sh;?>-show" class="showLink" onclick="showHide('r<?php echo $sh;?>');return false;">Show more...</a></p>
												<div id="r<?php echo $sh;?>" class="show_hide">
													...
													<p><a href="" id="r<?php echo $sh;?>-hide" class="hideLink" onclick="showHide('r<?php echo $sh;?>');return false;">Hide</a></p>
												</div>											
											</div>
									<?php
										}
